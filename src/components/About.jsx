        ...
        <div className="row d-flex justify-content-center align-items-center">
          <div className="col-10">
            ...
            <h5 style={{fontSize:`${fontSize}`,}} className="text-capitalize">
              ...
              Join us in our quest to spread love, laughter, and support. Together, we can turn compassion into action and make the world a better place, one smile at a time.
            </h5>
          </div>
        </div>
      </div>
